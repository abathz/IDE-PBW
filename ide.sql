...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2017 at 05:06 AM
...
INSERT INTO `enrollments` (`ID_U`, `ID_C`) VALUES
(1, 1),
(1, 2),
(2, 3),
(2, 2);
...
--
ALTER TABLE `enrollments`
  ADD CONSTRAINT `ID_Courses` FOREIGN KEY (`ID_C`) REFERENCES `courses` (`ID_C`),
  ADD CONSTRAINT `ID_User` FOREIGN KEY (`ID_U`) REFERENCES `users` (`ID_U`);
